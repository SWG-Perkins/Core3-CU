object_draft_schematic_armor_armor_appearance_rebel_marine_bicep_r = object_draft_schematic_armor_shared_armor_appearance_rebel_marine_bicep_r:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_rebel_marine_bicep_r, "object/draft_schematic/armor/armor_appearance_rebel_marine_bicep_r.iff")
