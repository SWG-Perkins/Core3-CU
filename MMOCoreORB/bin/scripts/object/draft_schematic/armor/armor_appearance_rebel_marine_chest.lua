object_draft_schematic_armor_armor_appearance_rebel_marine_chest = object_draft_schematic_armor_shared_armor_appearance_rebel_marine_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel marine Armor Chest Piece",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_rebel_marine_chest, "object/draft_schematic/armor/armor_appearance_rebel_marine_chest.iff")
