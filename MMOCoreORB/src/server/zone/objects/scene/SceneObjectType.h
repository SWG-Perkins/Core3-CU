...
public:
	...
	const static int CYBERNETICARMR = 0x20000101;
	const static int CYBERNETICARML = 0x20000101;
	const static int CYBERNETICFOREARMR = 0x20000104;
	const static int CYBERNETICFOREARML = 0x20000104;
	const static int CYBERNETICHANDL = 0x20000105;
	const static int CYBERNETICHANDR = 0x20000105;
