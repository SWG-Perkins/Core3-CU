...
public:
	...
	const static int FORCEBUFFHITARMOR			= 67; // ManagedObject arg1 = player that stopped entertaining, long arg2 = flourish id
		const static int FORCEBUFFHITSHIELD			= 68; // ManagedObject arg1 = player that stopped entertaining, long arg2 = flourish id
		const static int SHIELDSHIT			= 69; // ManagedObject arg1 = player that stopped entertaining, long arg2 = flourish id
};
