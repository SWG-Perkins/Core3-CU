...
public:
	...
	static const int TARGET = 65; // 65: targetType
	static const int TARGETTYPE = 66; // 65: targetType
	static const int STRINGID = 67; // 66: stringId
	static const int VISIBLE = 68; // 67: visible
	static const int CALLONTARGET = 69; // 68: callOnTarget
	static const int COMMANDGROUP = 70; // 69: commandGroup
	static const int DISABLED = 71; // 70: disabled
	static const int MAXRANGETOTARGET = 72; // 71: maxRangeToTarget
	static const int GODLEVEL = 73; // 72: godLevel
	static const int DISPLAYGROUP = 74; // 73: displayGroup
	static const int ADDTOCOMBATQUEUE = 75; // 74: addToCombatQueue
	static const int VALIDWEAPON = 76;
	static const int COOLDOWNGROUP = 77;
	static const int WARMUPTIME = 78;
	static const int EXECUTETIME = 79;
	static const int COOLDOWNTIME = 80;
