...
void TemplateManager::loadTreArchive() {
	...
	path = ConfigManager::instance()->getTocPath();

	Vector<String> tocFilesToLoad = ConfigManager::instance()->getTocFiles();

	res = DataArchiveStore::instance()->loadTOCs(path, tocFilesToLoad);
